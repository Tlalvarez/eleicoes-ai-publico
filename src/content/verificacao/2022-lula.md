---
title: "Verificação Documental — Caso 2022 / Luiz Inácio Lula da Silva"
slug: "2022-lula"
ordem: 5
---
# Verificação Documental — Caso 2022 / Luiz Inácio Lula da Silva

**Anexo ao Backtest Piloto 2022 | Metodologia v1.0, seção 10**
**Fonte primária:** "Diretrizes para o Programa de Reconstrução e Transformação do Brasil — Lula Alckmin 2023-2026, Coligação Brasil da Esperança" (21 pp., 121 tópicos numerados, datado de agosto de 2022; versão registrada no TSE). Texto integral via espelho de imprensa (cartacapital.com.br, set/2022). Integridade: título, subtítulo, coligação de 9 partidos e contagem de "121 tópicos em 21 páginas" conferem exatamente com a descrição da imprensa da versão protocolada. **URL oficial para conferência manual** (bloqueada para acesso automatizado): `divulgacandcontas.tse.jus.br/candidaturas/oficial/2022/BR/BR/544/candidatos/893498/5_1659820284477.pdf`. Versão comparativa: diretrizes de jun/2022 (17 pp., 90 tópicos, espelho poder360). Verificação executada em 26/07/2026.

**Nota sobre o piloto:** o backtest 2022 foi executado em formato compacto — a Camada 1 do dry-run afirmou três coisas verificáveis (revogação do teto explícita; documento curto e genérico; aliança Alckmin como sinal de costura), sem tabela completa de 6 eixos. Este anexo verifica essas três afirmações **e** produz a primeira classificação documental completa dos 6 eixos, que passa a ser a referência do caso.
...
| 2022 Lula | 3/3 afirmações do dry-run confirmadas; 6 eixos classificados (novos, com citação) | 0 | 0 | ✅ concluído |
| 2022 Bolsonaro | — | — | — | pendente |
| 2002 / 2006 | — | — | — | pendente |
